...
const preguntas = [
  ...
  { letra: 'Ñ', pista: 'Contiene la Ñ: Ayuda pública registrada como ingreso.', solucion: 'subvención', estado: 'pendiente' },
  ...
  { letra: 'Q', pista: 'Contiene la Q: Conjunto de normas contables oficiales en España.', solucion: 'Plan General Contable', estado: 'pendiente' },
  { letra: 'R', pista: 'Con la R: Resultado final entre ingresos y gastos.', solucion: 'resultado del ejercicio', estado: 'pendiente' },
  { letra: 'S', pista: 'Con la S: Anotación contable que refleja una operación.', solucion: 'asiento contable', estado: 'pendiente' },
  { letra: 'T', pista: 'Con la T: Salida de dinero para liquidar una operación.', solucion: 'pago', estado: 'pendiente' },
  ...
  { letra: 'X', pista: 'Contiene la X: Proceso de cierre del ejercicio contable.', solucion: 'cierre contable', estado: 'pendiente' },
  { letra: 'Y', pista: 'Con la Y: Rentabilidad de una inversión.', solucion: 'yield', estado: 'pendiente' },
  { letra: 'Z', pista: 'Con la Z: Comparación entre bancos y contabilidad.', solucion: 'conciliación bancaria', estado: 'pendiente' }
];
